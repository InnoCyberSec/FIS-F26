...
This time, there is no `win` function to jump to, but we can use our own [shellcode](https://web.archive.org/web/20260225182400/http://shell-storm.org/shellcode/files/shellcode-811.html) and jump to it.
